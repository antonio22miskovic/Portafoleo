        ...
        >
          ...
          <div class="modal-body my-0 pb-0 px-4 pt-0">
            ...
            <div
              class="mb-2 date"
              :class="{ 'text-light': nightMode, pbgray: nightMode }"
              v-if="portfolio.user !== null && portfolio.password !== null"
            >
            <br>
             <h6>datos de para ingresar:</h6>
              <span>Usuario: {{portfolio.user}}</span>
              <br>
              <span> Password: {{portfolio.password}} </span>
            </div>
            <div
              class="mb-2 date"
              :class="{ 'text-light': nightMode, pbgray: nightMode }"
              v-else>
            <br>
             <h6>No se puede ingresar por temas de privacidad</h6>
