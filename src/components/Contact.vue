  ...
  methods: {
    ...
    sendEmail() {
      if (!this.email || !this.name || !this.text) {
        ...
        this.snackbarMessage = "Por favor ingrese todos los campos";
        ...
        emailjs
          ...
          .then(
            (result) => {
              this.showSnackbar = true;
              this.snackbarMessage = "Gracias! El mensaje fue enviado.";
            ...
            (error) => {
              this.showSnackbar = true;
              this.snackbarMessage = "Oops! hubo un error al enviar el email.";
              this.snackbarColor = "rgb(212, 149, 97)";
            }
          );
      }
